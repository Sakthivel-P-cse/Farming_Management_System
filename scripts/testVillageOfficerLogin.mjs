// Test village officer login
// Usage: node scripts/testVillageOfficerLogin.mjs
...
async function testVillageOfficerLogin() {
  try {
    console.log('🧪 Testing village officer login flow...\n');
    
    const email = 'village.rampur@glytch.gov.in';
    const password = 'Village@1234';
