    ...
    <div className="min-h-screen bg-gray-300 p-8">
      <div className="max-w-full mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Farmers Section */}
          <div className="bg-gray-100/80 rounded-xl shadow-lg p-6">
        ...
        {/* Recent Activities */}
        <div className="mt-8 bg-gray-100/80 rounded-xl shadow-lg p-6">
          <h3 className="text-responsive-2xl font-bold text-gray-800 mb-6">Recent Activities</h3>
          <div className="space-y-3">
            {recentActivities.map((activity, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-100 rounded-lg hover:bg-gray-100 transition-colors">
